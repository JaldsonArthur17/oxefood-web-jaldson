...
export default function EmpresaForm() {
    ...
    async function salvar() {
        try {
            if (idEmpresa) {
                await atualizarPorId(MAPPING_CONTROLLER_EMPRESA, idEmpresa, empresa);
    ...
    return (
        <div>
            ...
            {idEmpresa ?
                <Breadcrumbs items={[{ label: "Empresa" }, { label: "Alterar" }]} />
                :
                                ...
                                <div className="card rounded-box grid grow p-8" style={{ padding: '30px' }}>
                                    <fieldset className="fieldset w-full">
                                        ...
                                        <IMaskInput mask="000.000.000.000" value={empresa.inscricaoEstadual}
                                            onAccept={(value) => setEmpresa({ ...empresa, inscricaoEstadual: value })}
                                ...
                                <div className="card rounded-box grid grow p-8" style={{ padding: '30px' }}>
                                    <fieldset className="fieldset w-full">
                                        ...
                                        <IMaskInput mask="(00) 00000-0000" value={empresa.foneAlternativo}
                                            ...
                                            className="input input-bordered w-full" id="foneAlternativo" />
                                    </fieldset>
                                </div>
                            </div>
